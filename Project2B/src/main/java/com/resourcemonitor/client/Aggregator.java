        ...
        do {
            ...
            */
            ...
            for(Integer key : nodeMessageMap.keySet()){
            	allmesnode += nodeMessageMap.get(key).size();
            }
            for(Integer key : nodeMessageMap.keySet()){
            	...
            	cpu += (subtotalCpu/allmesnode);
            	mem += (subtotalMem/allmesnode);
            }
            //
            procCount = procMessageMap.size();
            for(Integer key : procMessageMap.keySet()){
            	allmesproc += procMessageMap.get(key).size();
            }
            for(Integer key : procMessageMap.keySet()){
            	double subtotalCpu = 0;
            	double subtotalMem = 0;
            	...
            	procCpu += (subtotalCpu/allmesproc);
            	procMem += (subtotalMem/allmesproc);
            }
            //
